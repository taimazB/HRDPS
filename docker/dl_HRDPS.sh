...
vars=(-WEonG_TMP_Sfc -WEonG_CONDASSN_Sfc -WEonG_CONDALPCPN_Sfc -WEonG_WSPD_Sfc -WEonG_GUST_Sfc _PRMSL_MSL _Humidex_Sfc _RH_AGL-2m _SNOD_Sfc _WCHIL_Sfc _TCDC_Sfc)
# vars=(-WEonG_TMP_Sfc -WEonG_CONDASSN_Sfc -WEonG_CONDALPCPN_Sfc -WEonG_WSPD_Sfc -WEonG_DPT_Sfc -WEonG_GUST_Sfc)

export var
parallel 'wget -nc ${dlLink}/${lastHour}/{2}/${lastAvailDateTime}_MSC_HRDPS{1}_RLatLon0.0225_PT{2}H.grib2' ::: ${vars[@]} ::: {001..048}
